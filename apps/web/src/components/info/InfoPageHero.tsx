...
export function InfoPageHero({ title, description, badge, meta }: InfoPageHeroProps) {
  return (
    <section className="from-brand-900 via-brand-800 to-brand-700 relative overflow-hidden bg-gradient-to-br px-4 pb-14 pt-16 text-center">
      ...
      <div className="relative mx-auto max-w-3xl">
        {badge && (
          <span className="inline-flex items-center rounded-full border border-white/15 bg-white/10 px-4 py-1.5 text-xs font-semibold uppercase tracking-wide text-white/90 backdrop-blur-sm">
            {badge}
          </span>
        )}

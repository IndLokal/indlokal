...
export default async function LoginPage({
  ...
  return (
    <LoginShell
      title="Sign in"
      description="Save communities, follow events, and pick up where you left off on any device."
      ...
      footer={
        <>
          ...
          <Link href="/" className="text-muted hover:text-foreground mt-3 block transition-colors">
            ← Continue browsing
          </Link>
        </>
      }
    >
      <div className="mt-8 space-y-4 text-left">
        {error && <LoginAlert tone="error">Sign-in failed. Please try again.</LoginAlert>}

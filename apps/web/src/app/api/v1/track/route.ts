...
const INTERACTION_TYPE_MAP: Record<string, string> = {
  ...
  [Events.JOURNEY_NEXT_ACTION_IMPRESSION]: 'VIEW',
  [Events.JOURNEY_NEXT_ACTION_CLICK]: 'CLICK_ACCESS',
  [Events.JOURNEY_NEXT_ACTION_COMPLETED]: 'SAVE',
  [Events.JOURNEY_STEP_COMPLETED]: 'SAVE',
  [Events.JOURNEY_RESUME_PROMPT_SHOWN]: 'VIEW',
  [Events.JOURNEY_RESUME_CLICKED]: 'CLICK_ACCESS',
  [Events.JOURNEY_PROGRESS_RESET]: 'SAVE',
  [Events.RESOURCE_CTA_IMPRESSION]: 'VIEW',
  [Events.RESOURCE_CTA_CLICK]: 'CLICK_ACCESS',
  [Events.RESOURCE_CTA_VARIANT_ASSIGNED]: 'VIEW',
  [Events.RESOURCES_ESSENTIALS_CLICK]: 'CLICK_ACCESS',
  [Events.RESOURCES_PERSONA_SELECTED]: 'CLICK_ACCESS',
  [Events.RESOURCES_TO_RELATED_CLICK]: 'CLICK_ACCESS',
...
const POSTHOG_EVENT_MAP: Record<string, AnalyticsEvent> = {
  ...
  [Events.JOURNEY_NEXT_ACTION_IMPRESSION]: Events.JOURNEY_NEXT_ACTION_IMPRESSION,
  [Events.JOURNEY_NEXT_ACTION_CLICK]: Events.JOURNEY_NEXT_ACTION_CLICK,
  [Events.JOURNEY_NEXT_ACTION_COMPLETED]: Events.JOURNEY_NEXT_ACTION_COMPLETED,
  [Events.JOURNEY_STEP_COMPLETED]: Events.JOURNEY_STEP_COMPLETED,
  [Events.JOURNEY_RESUME_PROMPT_SHOWN]: Events.JOURNEY_RESUME_PROMPT_SHOWN,
  [Events.JOURNEY_RESUME_CLICKED]: Events.JOURNEY_RESUME_CLICKED,
  [Events.JOURNEY_PROGRESS_RESET]: Events.JOURNEY_PROGRESS_RESET,
  ...
  [Events.RESOURCES_ESSENTIALS_CLICK]: Events.RESOURCES_ESSENTIALS_CLICK,
  [Events.RESOURCES_PERSONA_SELECTED]: Events.RESOURCES_PERSONA_SELECTED,
  [Events.RESOURCES_TO_RELATED_CLICK]: Events.RESOURCES_TO_RELATED_CLICK,

      ...
      <main className="flex-1">
        ...
        <section className="mx-auto max-w-3xl px-4 py-16">
          ...
          <p className="text-muted mt-4 leading-relaxed">
            Moving to Germany is exciting — but finding your community shouldn&apos;t be hard.
            Whether you&apos;re looking for a Telugu association, a Diwali celebration, a cricket
            group, or just a WhatsApp group of fellow Indians nearby, {siteConfig.name} makes it
            effortless to discover what&apos;s happening around you.
          </p>
          <p className="text-muted mt-4 leading-relaxed">

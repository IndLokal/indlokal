          ...
          <div className="space-y-5 md:pr-8">
            ...
            <div className="flex items-center gap-3 pt-1">
              <a
                ...
                className="text-muted hover:bg-brand-50 hover:text-brand-600 flex h-11 w-11 items-center justify-center rounded-lg bg-slate-100 transition-all hover:scale-105"
              >

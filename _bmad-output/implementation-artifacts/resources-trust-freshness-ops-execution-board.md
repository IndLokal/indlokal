...
| B2 Re-verification queue and SLA                  | Not Started | BE-PLATFORM + OPS + FE-WEB | Not started                                                                                       | Queue workflow validation              | SLA/priority model approved | B1 lifecycle states required               |

...
This document follows [docs/PRODUCT_DOCUMENT.md](../PRODUCT_DOCUMENT.md) and defines the durable brand rules for what is live now.

- Lead with the user job: helping Indians navigate life in Germany, city by city.
- Keep the live product framed as one connected discovery foundation: Communities + Events + Resources.
- Treat Journey Layer language as an extension of that foundation, not a replacement for it.
- Business and Connect are still gated and must never be presented as live features.
...
The capitalisation `IndLokal` is intentional and load-bearing: the capital `L` makes the bridge visible at a glance. Never collapse to `Indlokal` in prose, headlines, or wordmarks. URLs and handles use `indlokal` only because URLs are lowercase by web convention.
...
> For Indians living in Germany who want to discover and participate in community life, **IndLokal** is the city-first, activity-led guide that shows what’s happening, who’s active, how to get involved, and where to find the consular and expat-life resources you actually need - powered by a trusted community graph that ensures freshness, relevance, and quality.
...
If IndLokal were a person, they would be:

- **A well-connected friend, not a concierge.** Warm, helpful, opinionated, never salesy.
- **Quietly proud of two cultures.** Indian heritage worn lightly, German precision worn confidently.
- **Activity-first.** Talks about what’s happening this week, not what existed five years ago.
- **Trustworthy.** Says “we don’t know yet” instead of making things up.
- **Optimistic and grown-up.** No emoji confetti, no “🔥🚀”, no clickbait.
...
| Direct          | Curt                  |
| Specific        | Vague                 |
| Bilingual-aware | Show-offy with German |
| Confident       | Loud                  |
| Helpful         | Patronising           |
...
| Surface               | Tone                                   |
| --------------------- | -------------------------------------- |
| Product UI            | Calm, specific, instructive            |
| Marketing site        | Warm, confident, story-led             |
| Social (LinkedIn)     | Considered, insight-led, professional  |
| Social (Instagram)    | Visual, human, light                   |
| Email (transactional) | Plain, fast, useful                    |
| Email (newsletter)    | Curated, personal, weekly-friend voice |
...
9. **Always link to the source.** If we point to a community, we link to where they actually live (WhatsApp, Telegram, their site).

### Do / Don’t

| Don’t write                                              | Write instead                                                      |
| -------------------------------------------------------- | ------------------------------------------------------------------ |
| “Discover amazing Indian experiences in your city!”      | “12 Indian events in Stuttgart this week.”                         |
| “Join our revolutionary community platform.”             | “Find the Tamil, Telugu and Hindi groups already active near you.” |
| “We’re on a mission to connect every Indian in Germany.” | “We help you find your people, in the city you actually live in.”  |
...
## 12. Brand checklist (before anything ships)
...
- [ ] Logo: **Pulse mark** used (no pin, no monogram, no flame) and clear-space + minimum size respected (see Design Guidelines).
- [ ] Colours are from the official palette, not eyeballed.
- [ ] Both `.de` and `.com` work and resolve where expected.
